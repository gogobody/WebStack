<?php
/**
 * 基于开源项目<a href="https://github.com/WebStackPage/WebStackPage.github.io" rel="nofollow" target="_blank">WebStack</a>的一个主题，请尊重劳动成果 <ul><li>由<a href="https://bbs.geekscholar.net" rel="nofollow" target="_blank">钻芒博客</a>二次,内容包括新增顶栏和优化底栏及悬浮窗等N项。</li> <li>适配全新暗黑模式，支持cooke保存。</li><li>设置参数已整合至后台，无需手动修改HTML。</li><li>基于SEOGO.ME运营狗2019.12.01版本 此版本于2020年6月1日20:31:27二开打包</li><ul>
 *
 * @package WebStack
...
<div class="main-content">
    <nav class="navbar user-info-navbar" role="navigation">
        <ul class="user-info-menu left-links list-inline list-unstyled">
            ...
            <?php if ($this->options->zmki_ah == '1'): ?>
                <li>
                    <a href="javascript:switchNightMode()" target="_self" title="切换模式">
                        <svg class="icon zmki_dh" aria-hidden="true">
            ...
            <li class="hidden-sm hidden-xs" style="display: table">
                <div id="tp-weather-widget" style="display: table-cell;vertical-align: middle">
            </li>
        </ul>
